            ...
            function randomFrom(lowerValue,upperValue)
{
	...
	//console.log('result point 1');
        ...
        let spark_submit = spawnSync('/usr/local/spark/bin/spark-submit',['--class', 'recommend.MovieLensALS','/root/film_recommend/data2/Film_Recommend.jar', path, userid],{ shell:true, encoding: 'utf8' });
